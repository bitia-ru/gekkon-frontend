...
import { logIn, signUp, logOut } from '../../utils/navigation';
...
const Footer = ({
  ...
  const socialLinksSprite = require('../../../../img/social-links-sprite/social-links-sprite.svg');
      ...
      <div className="footer__container">
        <div className="footer__block-group">
          <div className="footer__item">
            <h3 className="footer__header">Аккаунт</h3>
          ...
          <div className="footer__item">
            <h3 className="footer__header">Разделы</h3>
            <ul className="footer__list">
              <li className="footer__list-item">
              ...
              <li className="footer__list-item">
                <Link
                  to="/crags"
                  className="footer__list-link footer__list-link-disabled"
                >
                  Скалы
                </Link>
              </li>
