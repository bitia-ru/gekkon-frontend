...
export const SpotsData = [
    {
        id: 1,
        name: 'Гравитация',
        info1: 'Более 800 м2 лазательной поверхности',
        info2: '12-метровый стенд на трудность',
        info3: '6,5 тысяч зацепок и рельефов',
    ...
    },
    {
        id: 2,
        name: 'Лаймстоун',
        info1: 'Около 800 м2 лазательной поверхности',
        info2: 'Деление зала на зоны',
        info3: 'Многофункциональная силовая рама',
